...
![Submit Request](/src/assets/ops-manager/submit-request.svg)
...
**Managers Required** <Badge text="optional" variant="caution"/>
- Enter the number of managers needed
- Default is 0 if not specified
- Useful for staffing requests

**Attachments**  <Badge text="optional" variant="caution"/>
...
After submission, you can track your requests by doing the following:
...
Requests display are denoted by the following colored status badges:
...
**Completed** <Badge text="Green" variant="success"/>
...
<Accordion >
  ...
  <AccordionItem title="Process Improvement">
    <p>
  ...
  <AccordionItem title="Operational Support">
    <p>
