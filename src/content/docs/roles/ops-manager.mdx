...
- [Update Your Requests →](../../how-to-guides/update-request)
...
- [Find Your Assigned Tasks →](../../how-to-guides/find-assigned-tasks)
- [Update Task Progress →](../../how-to-guides/update-subtask)
...
- [Events Mapping](../../features/rota-management/events-mapping) - Assign managers to events
- [Contract Allocation](../../features/rota-management/contract-allocation) - Manage contracts
- [Succession Planning](../../features/rota-management/succession-planning) - Plan backups
- [Schedules](../../features/schedules) - View your schedule and team schedules
...
[View Contract features →](../../features/contracts)
...
[View Event features →](../../features/events)
...
3. Monitor Pending CIPH-R for conflicts
