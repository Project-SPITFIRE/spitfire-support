...
- [Submit a Request →](/learning-materials/features/management/request-management)
- [Update Requests →](/learning-materials/features/management/request-management)
- [View all Request features →](/learning-materials/features/management/request-management)
...
- [View all EOS Actions features →](/learning-materials/features/management/eos-actions)
...
- [Events Mapping](/learning-materials/features/scheduling/rota-management/event-mapping) - Assign managers to events
- [Contract Allocation](/learning-materials/features/scheduling/rota-management/contract-allocation) - Manage contracts
- [Succession Planning](/learning-materials/features/scheduling/rota-management/succession-planning) - Plan backups
- [Schedules](/learning-materials/features/scheduling/schedules) - View your schedule and team schedules
