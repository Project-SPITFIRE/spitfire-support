...
<Accordion>
  <AccordionItem title="🔑 Admin - System Administrator">
    ...
    **Key features to explore:**
    • [User & Team Management →](../features/user-team-management) - Create and manage user accounts
    • [System Configuration →](../how-to-guides/access-config-centre) - Configure system settings
    • [Request Management →](../features/request-management) - View all system requests

    **Quick navigation:**
    • Admin → User Management (create/edit users)
    • Admin → Team Management (organize teams)  
    • Admin → Configuration Centre (system settings)
  ...
  <AccordionItem title="🎯 Operations Support - Operational Coordinator">
    ...
    **Key features to explore:**
    • [Request Management →](../features/request-management) - Process and track all requests
    • [EOS Tasks →](../features/eos-tasks) - Create and coordinate operational tasks
    • [Operational Tracker →](../roles/ops-support) - Monitor system-wide operations

    **Quick navigation:**
    • Dashboard → Request Queue (process requests)
    • Management → EOS Actions (create/manage tasks)
    • Support → Operational Tracker (monitor operations)
    • Full access to schedules and rota management
  </AccordionItem>
  ...
  <AccordionItem title="👥 Operations Manager - Team Leader">
    ...
    **Key features to explore:**
    • [Schedules →](../features/schedules) - Manage your schedule and availability
    • [Rota Management →](../features/rota-management) - Plan event assignments and coverage
    • [EOS Tasks →](../features/eos-tasks) - Track and update assigned tasks

    **Quick navigation:**
    • Scheduling → Schedules (view your schedule)
    • Scheduling → Rota Management (plan events)
    • Management → EOS Actions (your assigned tasks)
    • Submit requests for team needs
  </AccordionItem>
...
1. **Deep dive into your features** - [Explore detailed feature documentation →](../features/)
2. **Learn specific procedures** - [Review how-to guides →](../how-to-guides/)
3. **Understand workflows** - Learn how your role fits into broader operational processes
4. **Optimize your usage** - Discover advanced features and shortcuts
