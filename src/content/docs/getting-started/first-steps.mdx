...
<Accordion>
  <AccordionItem title="🔑 Admin - System Administrator">
    ...
    **Key features to explore:**
    • [User & Team Management →](/features/management/user-team-management)
    {/* • [System Configuration →](../how-to-guides/access-config-centre) - Configure system settings */}
    • [Request Management →](/features/management/request-management)
  ...
  <AccordionItem title="🎯 Operations Support - Operational Coordinator">
    ...
    **Key features to explore:**
    • [Request Management →](/features/management/request-management) - Process and track all requests
    • [EOS Tasks →](/features/management/eos-actions) - Create and coordinate operational tasks
  ...
  <AccordionItem title="👥 Operations Manager - Team Leader">
    ...
    **Key features to explore:**
    • [Schedules →](/features/scheduling/schedules) - Manage your schedule and availability
    • [Rota Management →](/features/scheduling/rota-management) - Plan event assignments and coverage
    • [EOS Tasks →](/features/management/eos-actions)
...
1. **Deep dive into your features** - [Explore detailed feature documentation →](/features/overview)
